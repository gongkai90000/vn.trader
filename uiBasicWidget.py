...
class TradingWidget(QtGui.QFrame):
    ...
    def initUi(self):
        ...
        self.lineSymbol = QtGui.QLineEdit()  #zyp QLineEdit是一个单行文本输入框。 用于输入合约代码
        ...
        self.lineSymbol.returnPressed.connect(self.updateSymbol)  #zyp  合约代码的单行文本输入框中，回车后调用TradingWidget.updateSymbol(self)函数
